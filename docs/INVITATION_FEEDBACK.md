...
| 21 | scroll terasa terlalu cepat untuk user awam | `smooth-scroll.tsx`: touch now goes through Lenis (`syncTouch`, multiplier 1, inertia exponent 1.55, lerp 0.09), wheel 0.85; vow and couple wrappers stretched (420 / 580lvh). The first cut (0.8 / 1.4 / 450 / 620) was "too slow and heavy" on the owner's phone, eased the same day. Needs an iOS check: if the synthetic touch fights Safari, turn `syncTouch` off and keep the longer sections. |
