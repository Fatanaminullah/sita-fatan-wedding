...
/**
 * The number this thread is with, which is the one fact the name cannot carry.
 *
 * A guest's row can hold the wrong number, and when it does the thread is
...
function Thread({
  ...
  return (
    <div className="space-y-4">
      <GuestContext guest={conversation.guest} waId={conversation.waId} />
